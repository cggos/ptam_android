 ...
 */
JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_init( JNIEnv* env, jobject thiz, jintArray size)
{
    env->GetJavaVM(&jvm);
 ...
 */
JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_send( JNIEnv* env, jobject thiz, jstring command )
{
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_chenguang_ptam_PTAM_mapIsGood( JNIEnv* env, jobject thiz )
{
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_chenguang_ptam_PTAM_objectIsGood( JNIEnv* env, jobject thiz )
{
    System* s = System::get_instance();
 ...
 */
JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_start( JNIEnv* env, jobject thiz )
{
    System* s = System::get_instance();
    s->started = true;
}
 ...
 */
JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_stop( JNIEnv* env, jobject thiz )
{
    System* s = System::get_instance();
    s->started = false;
}
 ...
 * and its rotation.
 */
JNIEXPORT jfloatArray JNICALL Java_com_chenguang_ptam_PTAM_getModelView( JNIEnv* env, jobject thiz)
{
    System* s = System::get_instance();
...
JNIEXPORT jlong JNICALL Java_com_chenguang_ptam_PTAM_getTime( JNIEnv* env, jobject thiz)
{
    System* s = System::get_instance();
    return (jlong)s->time;
}
 ...
 */
JNIEXPORT jfloatArray JNICALL Java_com_chenguang_ptam_PTAM_getCorners( JNIEnv* env, jobject thiz)
{
    System* s = System::get_instance();
 ...
 */
JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_update( JNIEnv* env, jobject thiz, jbyteArray array )
{
    System* s = System::get_instance();
...
/* JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_initcalib( JNIEnv* env, jobject thiz, jintArray size) */
/* { */
/*     env->GetJavaVM(&jvm); */
/*     jvm->AttachCurrentThread(&env, NULL); */
...
/* JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_sendcalib( JNIEnv* env, jobject thiz, jstring command ) */
/* { */
/*     const char* c = env->GetStringUTFChars(command, 0); */
...
/* JNIEXPORT void JNICALL Java_com_chenguang_ptam_PTAM_updatecalib( JNIEnv* env, jobject thiz, jbyteArray array ) */
/* { */
